...
{ public:
  ...
  public:
   ...
   static int32_t AltitudeDelta(int32_t PressureDelta, int32_t PressureLapseRate) // [Pa], [0.0001 m/Pa] => [0.01 m]
   { return (PressureDelta*PressureLapseRate)/100; }

   static int32_t AltitudeDelta(int32_t PressureDelta, int32_t Pressure, int32_t Temperature)
   { int32_t PLR=PressureLapseRate(Pressure, Temperature); return AltitudeDelta(PressureDelta, PLR); }

   static int32_t StdAltitude(int32_t Pressure, int32_t PressStep=100)
