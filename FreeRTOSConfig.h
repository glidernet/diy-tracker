...
// non-trivial part to hook the SysClock interrupts right
...
#define configCPU_CLOCK_HZ		( ( unsigned long ) 60000000 )     // 60 MHz clock (after PLL)
#define configTICK_RATE_HZ		( ( TickType_t ) 1000 )            // 1000Hz = 1 tick/ms
#define configMAX_PRIORITIES		( 5 )
#define configMINIMAL_STACK_SIZE	( ( unsigned short ) 64 )
#define configTOTAL_HEAP_SIZE		( ( size_t ) ( 14 * 1024 ) )       // total RAM is 20kB
